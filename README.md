...
- `vdbg migrate-and-verify` one-shot migration, strict count validation, fingerprint comparison, and Markdown report CLI, with optional `--reset-target` cleanup for disposable smoke runs.
